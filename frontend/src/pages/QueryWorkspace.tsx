...
import { Play, MessageSquare, Database, Terminal, Loader2, Send, PanelRight } from 'lucide-react';
...
export const QueryWorkspace: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50 overflow-hidden">
            {/* Top Bar: Config & Question */}
            <div className="bg-white border-b border-gray-200 p-4 shadow-sm flex-shrink-0">
                <div className="flex gap-4 mb-4">
                    <div className="w-1/4">
                        <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Data Source</label>
                        <div className="relative">
                            <Database size={16} className="absolute left-3 top-2.5 text-gray-400" />
                            <select
                                className="block w-full pl-10 pr-3 py-2 text-sm border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md border"
